...
<div class="card mb-3">
    <div class="card-body">
        <form class="row g-2" method="get" action="customers.php">
            <div class="col-md-4">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                <a href="customers.php?id=<?php echo (int)$c['id_orang']; ?>&status=<?php echo htmlspecialchars($status, ENT_QUOTES, 'UTF-8'); ?>&q=<?php echo urlencode($q); ?>" class="btn btn-sm btn-outline-primary">
                                    Edit
                                </a>
                                <?php
            ...
            <div class="modal-body">
                <form method="post" autocomplete="off">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat" class="form-control" rows="3"><?php echo $edit_customer ? htmlspecialchars($edit_customer['alamat'], ENT_QUOTES, 'UTF-8') : ''; ?></textarea>
                    </div>
